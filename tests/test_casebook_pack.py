"""Regression checks for the copper-move-search-flow casebook."""
...
from casebook.harness import assert_expected, copper_move_search_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_move_search_flow_summary(), assert_expected())
